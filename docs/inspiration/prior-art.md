...
|---|---|---|
| Memos → vault promotion | [obsidian-memos-sync](https://github.com/RyoJerryYu/obsidian-memos-sync) (pulls memos into daily notes, attachments included); [Memos AI Sync+](https://www.obsidianstats.com/plugins/memos-ai-sync-plus) (same + AI) | Kills the copy-paste gap: promotion becomes moving text *within* the vault. See [fast-notes.md](../flows/fast-notes.md). |
